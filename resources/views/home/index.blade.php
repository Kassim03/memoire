...
<section class="room__container" id="salles">
  ...
  <h2 class="section__header">Nos meilleurs choix d'emplacements</h2>
  <p class="section__subheader">Des emplacements pensées pour inspirer, performer et collaborer avec fluidité.</p>
