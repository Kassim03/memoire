...
<head>
  ...
  <!-- Remix Icons -->
  <link href="" rel="<?php echo e(asset('css/remixicon.css')); ?>" />
  <!-- Google Fonts -->
  ...
  <nav>
    <div class="nav__bar">
      ...
      <ul class="nav__links" id="nav-links">
        ...
        <li><a href="<?php echo e(route('logout')); ?>" id="logout-links">Déconnexion</a></li>
      </ul>
...
</html><?php /**PATH C:\Users\22964\OneDrive\Images\STORM-1\Views/home/dashboard.blade.php ENDPATH**/ ?>