...
<body>
  ...
  <section class="pay-container">
    ...
    <form id="payForm" autocomplete="off" method="POST" action="<?php echo e(route('paiement.post')); ?>">
      <label for="name">Nom complet</label>
      <input type="text" id="name" name="name" placeholder="Votre nom" required value="<?php echo e($name . " " . $surname); ?>" />
      <label for="email">Adresse e‑mail</label>
      <input type="email" id="email" name="email" placeholder="mail@example.com" required value="<?php echo e($email); ?>"/>
        ...
        <script type="text/javascript">
          FedaPay.init("#pay-btn", {
            ...
            customer: {
              ...
              lastname: '<?php echo e($surname); ?>',
              firstname: '<?php echo e($name); ?>',
            },
  ...
  <?php /**PATH C:\Users\22964\OneDrive\Images\STORM-1\Views/home/Paiement.blade.php ENDPATH**/ ?>